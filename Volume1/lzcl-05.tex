...
\end{equation}
类似地, ${\mathscr{A}}^{\rho\sigma\tau}$必须正比于$\epsilon^{\rho\sigma\tau\eta}$与某个矩阵%
${\mathscr{A}}_{\eta}$的收缩, 令$\rho,\sigma,\tau$依次等于$0,1,2$或$0,1,3$或$0,2,3$或$1,2,3$, 我们发现
\begin{equation}
...
\end{equation}
通过调整场的整体标度, 我们可以选择零动量处的系数函数使其具有如下形式:
\begin{equation}
...
{\raisebox{-3ex}[0pt]{{\small[239]\hspace*{5mm}}}}]{{\raisebox{-3ex}[0pt]{\small\hspace*{5mm}[239]}}}
\begin{equation}
...
of Angular Momentum}} (John Wilety \& Sons, New York, 1957): Chapter III.
